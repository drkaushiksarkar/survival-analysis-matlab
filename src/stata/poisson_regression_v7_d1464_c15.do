* poisson_regression - Epidemiological Analysis v7 (d1464)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/poisson_regression_v7.log", replace
...
graph export "figures/poisson_regression_km_v7.png", replace
