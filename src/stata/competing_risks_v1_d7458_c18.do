* competing_risks - Epidemiological Analysis v1 (d7458)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/competing_risks_v1.log", replace
...
graph export "figures/competing_risks_km_v1.png", replace
