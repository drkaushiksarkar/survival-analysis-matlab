* log_rank_test - Disease Burden Analysis v9 (d2829)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/log_rank_test_burden_v9.log", replace
...
* Export results
export delimited using "output/log_rank_test_burden_v9.csv", replace
