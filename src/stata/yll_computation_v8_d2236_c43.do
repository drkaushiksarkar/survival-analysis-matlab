* yll_computation - Epidemiological Analysis v8 (d2236)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/yll_computation_v8.log", replace
...
graph export "figures/yll_computation_km_v8.png", replace
