* matrix_chain - Disease Burden Analysis v6 (d7957)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/matrix_chain_burden_v6.log", replace
...
* Export results
export delimited using "output/matrix_chain_burden_v6.csv", replace
