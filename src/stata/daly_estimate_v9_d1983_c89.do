* daly_estimate - Disease Burden Analysis v9 (d1983)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/daly_estimate_burden_v9.log", replace
...
* Export results
export delimited using "output/daly_estimate_burden_v9.csv", replace
