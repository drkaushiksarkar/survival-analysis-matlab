* competing_risks - Epidemiological Analysis v7 (d6542)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/competing_risks_v7.log", replace
...
graph export "figures/competing_risks_km_v7.png", replace
