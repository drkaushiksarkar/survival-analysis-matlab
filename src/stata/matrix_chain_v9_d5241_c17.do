* matrix_chain - Disease Burden Analysis v9 (d5241)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/matrix_chain_burden_v9.log", replace
...
* Export results
export delimited using "output/matrix_chain_burden_v9.csv", replace
