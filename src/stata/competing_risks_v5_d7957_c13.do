* competing_risks - Disease Burden Analysis v5 (d7957)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/competing_risks_burden_v5.log", replace
...
* Export results
export delimited using "output/competing_risks_burden_v5.csv", replace
