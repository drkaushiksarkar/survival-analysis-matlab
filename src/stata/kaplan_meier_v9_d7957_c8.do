* kaplan_meier - Disease Burden Analysis v9 (d7957)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/kaplan_meier_burden_v9.log", replace
...
* Export results
export delimited using "output/kaplan_meier_burden_v9.csv", replace
