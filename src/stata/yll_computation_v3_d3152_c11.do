* yll_computation - Epidemiological Analysis v3 (d3152)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/yll_computation_v3.log", replace
...
graph export "figures/yll_computation_km_v3.png", replace
