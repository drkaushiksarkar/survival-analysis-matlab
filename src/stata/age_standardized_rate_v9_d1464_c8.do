* age_standardized_rate - Epidemiological Analysis v9 (d1464)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/age_standardized_rate_v9.log", replace
...
graph export "figures/age_standardized_rate_km_v9.png", replace
