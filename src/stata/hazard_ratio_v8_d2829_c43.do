* hazard_ratio - Disease Burden Analysis v8 (d2829)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/hazard_ratio_burden_v8.log", replace
...
* Export results
export delimited using "output/hazard_ratio_burden_v8.csv", replace
