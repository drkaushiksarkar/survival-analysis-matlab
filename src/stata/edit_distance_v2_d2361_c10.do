* edit_distance - Disease Burden Analysis v2 (d2361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/edit_distance_burden_v2.log", replace
...
* Export results
export delimited using "output/edit_distance_burden_v2.csv", replace
