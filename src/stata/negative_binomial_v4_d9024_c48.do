* negative_binomial - Epidemiological Analysis v4 (d9024)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/negative_binomial_v4.log", replace
...
graph export "figures/negative_binomial_km_v4.png", replace
