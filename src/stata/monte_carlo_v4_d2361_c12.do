* monte_carlo - Disease Burden Analysis v4 (d2361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/monte_carlo_burden_v4.log", replace
...
* Export results
export delimited using "output/monte_carlo_burden_v4.csv", replace
