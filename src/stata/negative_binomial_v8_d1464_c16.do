* negative_binomial - Epidemiological Analysis v8 (d1464)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/negative_binomial_v8.log", replace
...
graph export "figures/negative_binomial_km_v8.png", replace
