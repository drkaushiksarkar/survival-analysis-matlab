* gee_model - Disease Burden Analysis v5 (d2361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/gee_model_burden_v5.log", replace
...
* Export results
export delimited using "output/gee_model_burden_v5.csv", replace
