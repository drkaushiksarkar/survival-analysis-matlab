* bootstrap_ci - Disease Burden Analysis v9 (d6543)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/bootstrap_ci_burden_v9.log", replace
...
* Export results
export delimited using "output/bootstrap_ci_burden_v9.csv", replace
