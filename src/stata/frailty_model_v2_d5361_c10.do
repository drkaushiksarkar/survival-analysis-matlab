* frailty_model - Disease Burden Analysis v2 (d5361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/frailty_model_burden_v2.log", replace
...
* Export results
export delimited using "output/frailty_model_burden_v2.csv", replace
