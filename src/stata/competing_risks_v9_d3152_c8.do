* competing_risks - Epidemiological Analysis v9 (d3152)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/competing_risks_v9.log", replace
...
graph export "figures/competing_risks_km_v9.png", replace
