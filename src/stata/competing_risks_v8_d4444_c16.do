* competing_risks - Epidemiological Analysis v8 (d4444)
* Source: Global Burden of Disease (IHME/GBD)
* Stata 14+ required

capture log close
log using "results/competing_risks_v8.log", replace
...
graph export "figures/competing_risks_km_v8.png", replace
