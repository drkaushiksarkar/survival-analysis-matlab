* merge_sort - Disease Burden Analysis v6 (d2361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/merge_sort_burden_v6.log", replace
...
* Export results
export delimited using "output/merge_sort_burden_v6.csv", replace
