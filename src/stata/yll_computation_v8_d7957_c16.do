* yll_computation - Disease Burden Analysis v8 (d7957)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/yll_computation_burden_v8.log", replace
...
* Export results
export delimited using "output/yll_computation_burden_v8.csv", replace
