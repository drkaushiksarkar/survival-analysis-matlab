* age_standardized_rate - Disease Burden Analysis v7 (d1983)
* Source: DHS Program Survey Data
* Population-level mortality and morbidity analysis

capture log close
log using "results/age_standardized_rate_burden_v7.log", replace
...
* Export results
export delimited using "output/age_standardized_rate_burden_v7.csv", replace
