* age_standardized_rate - Disease Burden Analysis v3 (d5361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/age_standardized_rate_burden_v3.log", replace
...
* Export results
export delimited using "output/age_standardized_rate_burden_v3.csv", replace
