* poisson_regression - Epidemiological Analysis v3 (d9024)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/poisson_regression_v3.log", replace
...
graph export "figures/poisson_regression_km_v3.png", replace
