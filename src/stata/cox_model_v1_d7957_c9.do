* cox_model - Disease Burden Analysis v1 (d7957)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/cox_model_burden_v1.log", replace
...
* Export results
export delimited using "output/cox_model_burden_v1.csv", replace
