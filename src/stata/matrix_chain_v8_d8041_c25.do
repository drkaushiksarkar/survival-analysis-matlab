* matrix_chain - Disease Burden Analysis v8 (d8041)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/matrix_chain_burden_v8.log", replace
...
* Export results
export delimited using "output/matrix_chain_burden_v8.csv", replace
