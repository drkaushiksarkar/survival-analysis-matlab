* survival_curve - Disease Burden Analysis v2 (d7957)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_curve_burden_v2.log", replace
...
* Export results
export delimited using "output/survival_curve_burden_v2.csv", replace
