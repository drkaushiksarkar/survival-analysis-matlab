* age_standardized_rate - Epidemiological Analysis v3 (d7458)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/age_standardized_rate_v3.log", replace
...
graph export "figures/age_standardized_rate_km_v3.png", replace
