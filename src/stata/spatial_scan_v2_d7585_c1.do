* spatial_scan - Disease Burden Analysis v2 (d7585)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_scan_burden_v2.log", replace
...
* Export results
export delimited using "output/spatial_scan_burden_v2.csv", replace
