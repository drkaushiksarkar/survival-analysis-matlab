* poisson_regression - Epidemiological Analysis v1 (d7458)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/poisson_regression_v1.log", replace
...
graph export "figures/poisson_regression_km_v1.png", replace
