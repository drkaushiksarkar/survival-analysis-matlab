* hazard_ratio - Disease Burden Analysis v3 (d7957)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/hazard_ratio_burden_v3.log", replace
...
* Export results
export delimited using "output/hazard_ratio_burden_v3.csv", replace
