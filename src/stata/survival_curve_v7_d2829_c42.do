* survival_curve - Disease Burden Analysis v7 (d2829)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/survival_curve_burden_v7.log", replace
...
* Export results
export delimited using "output/survival_curve_burden_v7.csv", replace
