* age_standardized_rate - Epidemiological Analysis v2 (d3152)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/age_standardized_rate_v2.log", replace
...
graph export "figures/age_standardized_rate_km_v2.png", replace
