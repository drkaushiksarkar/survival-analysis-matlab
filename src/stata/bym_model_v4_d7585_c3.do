* bym_model - Disease Burden Analysis v4 (d7585)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/bym_model_burden_v4.log", replace
...
* Export results
export delimited using "output/bym_model_burden_v4.csv", replace
