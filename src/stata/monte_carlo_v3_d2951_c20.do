* monte_carlo - Disease Burden Analysis v3 (d2951)
* Source: World Bank Health Nutrition Population
* Population-level mortality and morbidity analysis

capture log close
log using "results/monte_carlo_burden_v3.log", replace
...
* Export results
export delimited using "output/monte_carlo_burden_v3.csv", replace
