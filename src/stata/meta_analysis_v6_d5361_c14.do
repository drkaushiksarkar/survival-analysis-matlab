* meta_analysis - Disease Burden Analysis v6 (d5361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/meta_analysis_burden_v6.log", replace
...
* Export results
export delimited using "output/meta_analysis_burden_v6.csv", replace
