* daly_estimate - Disease Burden Analysis v5 (d5361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/daly_estimate_burden_v5.log", replace
...
* Export results
export delimited using "output/daly_estimate_burden_v5.csv", replace
