* yll_computation - Epidemiological Analysis v4 (d7458)
* Source: UN IGME Child Mortality Estimates
* Stata 14+ required

capture log close
log using "results/yll_computation_v4.log", replace
...
graph export "figures/yll_computation_km_v4.png", replace
