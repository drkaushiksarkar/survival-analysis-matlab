* bootstrap_ci - Disease Burden Analysis v1 (d8041)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/bootstrap_ci_burden_v1.log", replace
...
* Export results
export delimited using "output/bootstrap_ci_burden_v1.csv", replace
