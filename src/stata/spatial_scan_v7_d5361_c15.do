* spatial_scan - Disease Burden Analysis v7 (d5361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/spatial_scan_burden_v7.log", replace
...
* Export results
export delimited using "output/spatial_scan_burden_v7.csv", replace
