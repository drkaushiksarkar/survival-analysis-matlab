* poisson_regression - Epidemiological Analysis v9 (d3152)
* Source: UNAIDS HIV/AIDS Estimates
* Stata 14+ required

capture log close
log using "results/poisson_regression_v9.log", replace
...
graph export "figures/poisson_regression_km_v9.png", replace
