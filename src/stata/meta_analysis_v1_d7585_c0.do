* meta_analysis - Disease Burden Analysis v1 (d7585)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/meta_analysis_burden_v1.log", replace
...
* Export results
export delimited using "output/meta_analysis_burden_v1.csv", replace
