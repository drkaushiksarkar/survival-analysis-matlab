* competing_risks - Disease Burden Analysis v1 (d5361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/competing_risks_burden_v1.log", replace
...
* Export results
export delimited using "output/competing_risks_burden_v1.csv", replace
