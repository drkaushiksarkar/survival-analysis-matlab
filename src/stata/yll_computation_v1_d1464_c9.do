* yll_computation - Epidemiological Analysis v1 (d1464)
* Source: WHO Global Health Observatory (GHO)
* Stata 14+ required

capture log close
log using "results/yll_computation_v1.log", replace
...
graph export "figures/yll_computation_km_v1.png", replace
