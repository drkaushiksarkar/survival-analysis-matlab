* matrix_chain - Disease Burden Analysis v3 (d2361)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/matrix_chain_burden_v3.log", replace
...
* Export results
export delimited using "output/matrix_chain_burden_v3.csv", replace
