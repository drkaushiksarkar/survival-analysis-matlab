* bootstrap_ci - Disease Burden Analysis v4 (d2829)
* Source: WHO Malaria Report
* Population-level mortality and morbidity analysis

capture log close
log using "results/bootstrap_ci_burden_v4.log", replace
...
* Export results
export delimited using "output/bootstrap_ci_burden_v4.csv", replace
