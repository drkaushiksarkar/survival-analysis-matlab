* monte_carlo - Disease Burden Analysis v7 (d1837)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/monte_carlo_burden_v7.log", replace
...
* Export results
export delimited using "output/monte_carlo_burden_v7.csv", replace
