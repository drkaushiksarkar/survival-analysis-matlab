* competing_risks - Epidemiological Analysis v4 (d1562)
* Source: UN Population Division
* Stata 14+ required

capture log close
log using "results/competing_risks_v4.log", replace
...
graph export "figures/competing_risks_km_v4.png", replace
