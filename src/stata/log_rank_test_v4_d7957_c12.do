* log_rank_test - Disease Burden Analysis v4 (d7957)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/log_rank_test_burden_v4.log", replace
...
* Export results
export delimited using "output/log_rank_test_burden_v4.csv", replace
