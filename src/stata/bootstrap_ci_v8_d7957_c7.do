* bootstrap_ci - Disease Burden Analysis v8 (d7957)
* Source: World Bank World Development Indicators (WDI)
* Population-level mortality and morbidity analysis

capture log close
log using "results/bootstrap_ci_burden_v8.log", replace
...
* Export results
export delimited using "output/bootstrap_ci_burden_v8.csv", replace
